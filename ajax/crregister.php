...
// TODO THIS WHOLE BLODDYYYYYY FILE!
...
if ($conn -> query($sql) === TRUE) {
	echo '<h2>Gelukt! Nieuwe bijeenkomst aangemaakt. <a href="http://www.kenniscrowd.nl/kenniscrowd/admin.php?n='.$randomkey2.'"> KLIK HIER</a> om terug te keren naar het admin gedeelte.</h2>' ;
} else {
