...
<?php
	...
	//echo ($titelEventResult);

	$sql2 = "SELECT cats,eventname FROM events WHERE id='$currentid'";
	$result2 = mysql_query($sql2);
	while($row2 = mysql_fetch_assoc($result2))
	{
		$temp2 = $row2['cats'];
    $titelEventResult = $row2['eventname'];
	}
	...
	<body>
		<img src="legenda2.jpg" alt="Legenda" style="top: 0px; left: 0px; position: fixed; z-index:0">
		<svg id="graph"></svg>
		<div class="titelEvent">
			<p>Bijeenkomst:
				<?php echo $titelEventResult;?>
			</p>
		</div>
		<div class="ui-widget">
			<input id="search">
        ...
        //echo "console.log(".$titelEventResult.");\n";
				...
				node.append("circle")
					...
					.attr("r", function (d, i) {
						if (kennisGroep[i] == 1) {
							...
							return config.avatar_size / 2 + "px";
						}
					})
