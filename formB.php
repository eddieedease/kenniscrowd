        ...
        <div class="col-md-8">
          <div class="well">
            <form class="form-horizontal" role="form">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button class="btn btn-default" ng-model='files[0]' ng-click="registeruser($files)">Verstuur!</button>
                </div>
              </div>
          ...
          <br>
          <br>
          <a href="http://www.kenniscloud.nl/kenniscrowd?c={{keyy}}" target="_blanc">Klik hier om de bijbehorende crowd te openen.</a>
        </div>
        <br>
        <br>
        <br>
